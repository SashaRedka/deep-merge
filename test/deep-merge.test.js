...
describe("Deep Merge testing", () => {
  ...
  it("4. Expects [] and [] with primitives to be equal new array", () => {
    expect(
      deepMerge([3, "sdf", null, [undefined], 0], [4, 5, "hhhh", undefined])
    ).to.deep.equal([3, "sdf", null, [undefined], 0, 4, 5, "hhhh", undefined]);
  });
  ...
  it("6. Expects deep merge objects", () => {
    expect(deepMerge({ a: 1, b: 3, c: 4 }, { a: 5, b: 6, c: 7 })).to.deep.equal(
      { a: 5, b: 6, c: 7 }
    );

    expect(
      deepMerge({ a: 1, c: { j: 1, b: 2 } }, { a: 5, b: 6, c: { j: 2, h: 7 } })
    ).to.deep.equal({ a: 5, b: 6, c: { j: 2, b: 2, h: 7 } });

    expect(
      deepMerge(
        { a: 1, c: { j: [1, 5, null], b: 2 } },
        { a: 5, b: 6, c: { j: [10], h: 7 } }
      )
    ).to.deep.equal({ a: 5, b: 6, c: { j: [1, 5, null, 10], b: 2, h: 7 } });
  });
